  ...
  return /******/ (() => {
    ...
    __webpack_require__.d(__webpack_exports__, {
      ...
      TimelineKeyframeChangedEvent: () =>
        /* reexport */ TimelineKeyframeChangedEvent,
      ...
      defaultTimelineKeyframeStyle: () =>
        /* reexport */ defaultTimelineKeyframeStyle,
        ...
        },
        {
          ...
          value: function off(topic, callback) {
            ...
            this._subscriptions = this._subscriptions.filter(function (event) {
              return (
                event && event.callback != callback && event.topic != topic
              );
            });
        ...
        },
        {
          ...
          value: function emit(topic, args) {
            this._subscriptions.forEach(function (event) {
              if (
                (event === null || event === void 0 ? void 0 : event.topic) ===
                  topic &&
                event !== null &&
                event !== void 0 &&
                event.callback
    ...
    })(TimelineKeyframeShape || (TimelineKeyframeShape = {})); // CONCATENATED MODULE: ./src/utils/timelineUtils.ts
    function timelineUtils_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (timelineUtils_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
            ? function (obj) {
                return typeof obj;
              }
        ...
        timelineUtils_typeof(obj)
      );
    }
    function timelineUtils_classCallCheck(instance, Constructor) {
      if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
      }
    }
    function timelineUtils_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          timelineUtils_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function timelineUtils_createClass(Constructor, protoProps, staticProps) {
      if (protoProps)
        timelineUtils_defineProperties(Constructor.prototype, protoProps);
      if (staticProps) timelineUtils_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function timelineUtils_defineProperty(obj, key, value) {
      key = timelineUtils_toPropertyKey(key);
      if (key in obj) {
        Object.defineProperty(obj, key, {
          value: value,
          enumerable: true,
    ...
    function timelineUtils_toPropertyKey(arg) {
      var key = timelineUtils_toPrimitive(arg, "string");
      return timelineUtils_typeof(key) === "symbol" ? key : String(key);
    }
    function timelineUtils_toPrimitive(input, hint) {
      if (timelineUtils_typeof(input) !== "object" || input === null)
        return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (timelineUtils_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
      ...
      timelineUtils_createClass(TimelineUtils, null, [
        ...
        },
        {
          ...
          value: function findGoodStep(originalStep) {
            ...
            for (var i = 0; i < denominators.length; i++) {
              ...
              var distance = TimelineUtils.getDistance(
                originalStep,
                calculatedStep
              );
        ...
        },
        {
          ...
          value: function setMinMax(to, from) {
            ...
            var toMin = to.min;
            var isFromMinNumber =
              (fromMin || fromMin === 0) && TimelineUtils.isNumber(fromMin);
            var isToMinNumber =
              (toMin || toMin === 0) && TimelineUtils.isNumber(toMin);
            // get absolute min and max bounds:
            if (isFromMinNumber && isToMinNumber) {
              to.min = shrink
                ? Math.min(fromMin, toMin)
            ...
            var toMax = to.max;
            var isFromMaxNumber =
              (fromMax || fromMax === 0) && TimelineUtils.isNumber(fromMax);
            var isToMaxNumber =
              (toMax || toMax === 0) && TimelineUtils.isNumber(toMax);
            if (isFromMaxNumber && isToMaxNumber) {
              to.max = shrink
                ? Math.max(fromMax, toMax)
                : Math.min(fromMax, toMax);
        ...
        },
        {
          ...
          value: function getPowArgument(toCheck) {
            ...
            if (toCheck > 1) {
              ...
              var zerosCount =
                Math.floor(Math.log(toCheck) / Math.log(10) + 1) - 1;
              return zerosCount;
            } else {
              return 1;
            }
    ...
    timelineUtils_defineProperty(
      ...
      "cloneOptions",
      function (previousOptions) {
        var clonedValue = JSON.parse(
          JSON.stringify(previousOptions, function (key, value) {
    ...
    function timelineStyleUtils_classCallCheck(instance, Constructor) {
      if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
      }
    }
    function timelineStyleUtils_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          timelineStyleUtils_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function timelineStyleUtils_createClass(
      ...
      if (protoProps)
        timelineStyleUtils_defineProperties(Constructor.prototype, protoProps);
      if (staticProps)
        timelineStyleUtils_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function timelineStyleUtils_toPropertyKey(arg) {
      var key = timelineStyleUtils_toPrimitive(arg, "string");
      return timelineStyleUtils_typeof(key) === "symbol" ? key : String(key);
    }
    function timelineStyleUtils_toPrimitive(input, hint) {
      if (timelineStyleUtils_typeof(input) !== "object" || input === null)
        return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (timelineStyleUtils_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    function timelineStyleUtils_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (timelineStyleUtils_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
            ? function (obj) {
                return typeof obj;
              }
      ...
      timelineStyleUtils_createClass(TimelineStyleUtils, null, [
        ...
        },
        {
          ...
          value: function getGroupStyle(groupModel) {
            ...
            return (
              ((_TimelineStyleUtils$g =
                TimelineStyleUtils.getGroup(groupModel)) === null ||
              _TimelineStyleUtils$g === void 0
                ? void 0
                : _TimelineStyleUtils$g.style) || null
            );
          },
        },
        {
          ...
          value: function getFirstSet(defaultValue) {
            ...
            return TimelineStyleUtils.getValue.apply(
              TimelineStyleUtils,
              [defaultValue, false].concat(params)
            );
          },
          /**
        ...
        },
        {
          ...
          value: function getValue(defaultValue) {
            ...
            var toReturn =
              valuesFound && valuesFound.length > 0
                ? valuesFound[0]
                : defaultValue;
            if (found) {
              return false;
        ...
        },
        {
          ...
          value: function keyframeWidth(keyframe, group, rowStyle, options) {
            var _keyframe$style,
              ...
              _TimelineStyleUtils$g3,
              _rowStyle$keyframesSt,
              _rowStyle$groupsStyle,
              _rowStyle$groupsStyle2,
              _options$rowsStyle,
              _options$rowsStyle$gr,
              _options$rowsStyle$gr2,
              _options$rowsStyle2,
              _options$rowsStyle2$k;
            return TimelineStyleUtils.getFirstSet(
              // default value
              defaultTimelineKeyframeStyle.width || "",
              keyframe === null || keyframe === void 0
                ? void 0
                : (_keyframe$style = keyframe.style) === null ||
                  _keyframe$style === void 0
                ? void 0
                : _keyframe$style.width, // exact style
              (_TimelineStyleUtils$g2 =
                TimelineStyleUtils.getGroupStyle(group)) === null ||
                _TimelineStyleUtils$g2 === void 0
                ? void 0
                : (_TimelineStyleUtils$g3 =
                    _TimelineStyleUtils$g2.keyframesStyle) === null ||
                  _TimelineStyleUtils$g3 === void 0
                ? void 0
                : _TimelineStyleUtils$g3.width,
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$keyframesSt = rowStyle.keyframesStyle) === null ||
                  _rowStyle$keyframesSt === void 0
                ? void 0
                : _rowStyle$keyframesSt.width,
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$groupsStyle = rowStyle.groupsStyle) === null ||
                  _rowStyle$groupsStyle === void 0
                ? void 0
                : (_rowStyle$groupsStyle2 =
                    _rowStyle$groupsStyle.keyframesStyle) === null ||
                  _rowStyle$groupsStyle2 === void 0
                ? void 0
                : _rowStyle$groupsStyle2.width, // global styles
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle = options.rowsStyle) === null ||
                  _options$rowsStyle === void 0
                ? void 0
                : (_options$rowsStyle$gr = _options$rowsStyle.groupsStyle) ===
                    null || _options$rowsStyle$gr === void 0
                ? void 0
                : (_options$rowsStyle$gr2 =
                    _options$rowsStyle$gr.keyframesStyle) === null ||
                  _options$rowsStyle$gr2 === void 0
                ? void 0
                : _options$rowsStyle$gr2.width, // default keyframe style
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle2 = options.rowsStyle) === null ||
                  _options$rowsStyle2 === void 0
                ? void 0
                : (_options$rowsStyle2$k =
                    _options$rowsStyle2.keyframesStyle) === null ||
                  _options$rowsStyle2$k === void 0
                ? void 0
                : _options$rowsStyle2$k.width
            );
          },
        },
        {
          ...
          value: function keyframeHeight(keyframe, group, rowStyle, options) {
            var _keyframe$style2,
              _TimelineStyleUtils$g4,
              _TimelineStyleUtils$g5,
              _rowStyle$keyframesSt2,
              _rowStyle$groupsStyle3,
              _rowStyle$groupsStyle4,
              _options$rowsStyle3,
              _options$rowsStyle3$g,
              _options$rowsStyle3$g2,
              _options$rowsStyle4,
              _options$rowsStyle4$k;
            return TimelineStyleUtils.getFirstSet(
              // default value
              defaultTimelineKeyframeStyle.height || "",
              keyframe === null || keyframe === void 0
                ? void 0
                : (_keyframe$style2 = keyframe.style) === null ||
                  _keyframe$style2 === void 0
                ? void 0
                : _keyframe$style2.height, // exact style
              (_TimelineStyleUtils$g4 =
                TimelineStyleUtils.getGroupStyle(group)) === null ||
                _TimelineStyleUtils$g4 === void 0
                ? void 0
                : (_TimelineStyleUtils$g5 =
                    _TimelineStyleUtils$g4.keyframesStyle) === null ||
                  _TimelineStyleUtils$g5 === void 0
                ? void 0
                : _TimelineStyleUtils$g5.height,
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$keyframesSt2 = rowStyle.keyframesStyle) === null ||
                  _rowStyle$keyframesSt2 === void 0
                ? void 0
                : _rowStyle$keyframesSt2.height,
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$groupsStyle3 = rowStyle.groupsStyle) === null ||
                  _rowStyle$groupsStyle3 === void 0
                ? void 0
                : (_rowStyle$groupsStyle4 =
                    _rowStyle$groupsStyle3.keyframesStyle) === null ||
                  _rowStyle$groupsStyle4 === void 0
                ? void 0
                : _rowStyle$groupsStyle4.height, // global styles
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle3 = options.rowsStyle) === null ||
                  _options$rowsStyle3 === void 0
                ? void 0
                : (_options$rowsStyle3$g = _options$rowsStyle3.groupsStyle) ===
                    null || _options$rowsStyle3$g === void 0
                ? void 0
                : (_options$rowsStyle3$g2 =
                    _options$rowsStyle3$g.keyframesStyle) === null ||
                  _options$rowsStyle3$g2 === void 0
                ? void 0
                : _options$rowsStyle3$g2.height, // default keyframe style
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle4 = options.rowsStyle) === null ||
                  _options$rowsStyle4 === void 0
                ? void 0
                : (_options$rowsStyle4$k =
                    _options$rowsStyle4.keyframesStyle) === null ||
                  _options$rowsStyle4$k === void 0
                ? void 0
                : _options$rowsStyle4$k.height
            );
          },
        },
        {
          ...
          value: function keyframeShape(keyframe, group, rowStyle, options) {
            var _keyframe$style3,
              _TimelineStyleUtils$g6,
              _TimelineStyleUtils$g7,
              _rowStyle$groupsStyle5,
              _rowStyle$groupsStyle6,
              _rowStyle$keyframesSt3,
              _options$rowsStyle5,
              _options$rowsStyle5$g,
              _options$rowsStyle5$g2,
              _options$rowsStyle6,
              _options$rowsStyle6$k;
            var defaultValue =
              defaultTimelineKeyframeStyle.shape || TimelineKeyframeShape.Rhomb;
            return TimelineStyleUtils.getFirstSet(
              // default value
              defaultValue, // exact style
              keyframe === null || keyframe === void 0
                ? void 0
                : (_keyframe$style3 = keyframe.style) === null ||
                  _keyframe$style3 === void 0
                ? void 0
                : _keyframe$style3.shape, // style set by keyframe group
              (_TimelineStyleUtils$g6 =
                TimelineStyleUtils.getGroupStyle(group)) === null ||
                _TimelineStyleUtils$g6 === void 0
                ? void 0
                : (_TimelineStyleUtils$g7 =
                    _TimelineStyleUtils$g6.keyframesStyle) === null ||
                  _TimelineStyleUtils$g7 === void 0
                ? void 0
                : _TimelineStyleUtils$g7.shape, // style from the keyframe group
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$groupsStyle5 = rowStyle.groupsStyle) === null ||
                  _rowStyle$groupsStyle5 === void 0
                ? void 0
                : (_rowStyle$groupsStyle6 =
                    _rowStyle$groupsStyle5.keyframesStyle) === null ||
                  _rowStyle$groupsStyle6 === void 0
                ? void 0
                : _rowStyle$groupsStyle6.shape, // style set by keyframe style
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$keyframesSt3 = rowStyle.keyframesStyle) === null ||
                  _rowStyle$keyframesSt3 === void 0
                ? void 0
                : _rowStyle$keyframesSt3.shape,
              // style set by keyframe group style, applied when group is set
              group
                ? options === null || options === void 0
                  ? void 0
                  : (_options$rowsStyle5 = options.rowsStyle) === null ||
                    _options$rowsStyle5 === void 0
                  ? void 0
                  : (_options$rowsStyle5$g =
                      _options$rowsStyle5.groupsStyle) === null ||
                    _options$rowsStyle5$g === void 0
                  ? void 0
                  : (_options$rowsStyle5$g2 =
                      _options$rowsStyle5$g.keyframesStyle) === null ||
                    _options$rowsStyle5$g2 === void 0
                  ? void 0
                  : _options$rowsStyle5$g2.shape
                : undefined, // Style set by global options
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle6 = options.rowsStyle) === null ||
                  _options$rowsStyle6 === void 0
                ? void 0
                : (_options$rowsStyle6$k =
                    _options$rowsStyle6.keyframesStyle) === null ||
                  _options$rowsStyle6$k === void 0
                ? void 0
                : _options$rowsStyle6$k.shape
            );
          },
        },
        {
          key: "keyframeFillColor",
          value: function keyframeFillColor(
            keyframe,
            group,
            rowStyle,
            options
          ) {
            var _keyframe$style4,
              _TimelineStyleUtils$g8,
              _TimelineStyleUtils$g9,
              _rowStyle$groupsStyle7,
              _rowStyle$groupsStyle8,
              _rowStyle$keyframesSt4,
              _options$rowsStyle7,
              _options$rowsStyle7$g,
              _options$rowsStyle7$g2,
              _options$rowsStyle8,
              _options$rowsStyle8$k;
            ...
            return TimelineStyleUtils.getFirstSet(
              ...
              keyframe === null || keyframe === void 0
                ? void 0
                : (_keyframe$style4 = keyframe.style) === null ||
                  _keyframe$style4 === void 0
                ? void 0
                : _keyframe$style4.fillColor, // style set by keyframe group
              (_TimelineStyleUtils$g8 =
                TimelineStyleUtils.getGroupStyle(group)) === null ||
                _TimelineStyleUtils$g8 === void 0
                ? void 0
                : (_TimelineStyleUtils$g9 =
                    _TimelineStyleUtils$g8.keyframesStyle) === null ||
                  _TimelineStyleUtils$g9 === void 0
                ? void 0
                : _TimelineStyleUtils$g9.fillColor, // style from the keyframe group
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$groupsStyle7 = rowStyle.groupsStyle) === null ||
                  _rowStyle$groupsStyle7 === void 0
                ? void 0
                : (_rowStyle$groupsStyle8 =
                    _rowStyle$groupsStyle7.keyframesStyle) === null ||
                  _rowStyle$groupsStyle8 === void 0
                ? void 0
                : _rowStyle$groupsStyle8.fillColor, // style set by keyframe style
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$keyframesSt4 = rowStyle.keyframesStyle) === null ||
                  _rowStyle$keyframesSt4 === void 0
                ? void 0
                : _rowStyle$keyframesSt4.fillColor,
              // style set by keyframe group style, applied when group is set
              group
                ? options === null || options === void 0
                  ? void 0
                  : (_options$rowsStyle7 = options.rowsStyle) === null ||
                    _options$rowsStyle7 === void 0
                  ? void 0
                  : (_options$rowsStyle7$g =
                      _options$rowsStyle7.groupsStyle) === null ||
                    _options$rowsStyle7$g === void 0
                  ? void 0
                  : (_options$rowsStyle7$g2 =
                      _options$rowsStyle7$g.keyframesStyle) === null ||
                    _options$rowsStyle7$g2 === void 0
                  ? void 0
                  : _options$rowsStyle7$g2.fillColor
                : undefined, // Style set by global options
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle8 = options.rowsStyle) === null ||
                  _options$rowsStyle8 === void 0
                ? void 0
                : (_options$rowsStyle8$k =
                    _options$rowsStyle8.keyframesStyle) === null ||
                  _options$rowsStyle8$k === void 0
                ? void 0
                : _options$rowsStyle8$k.fillColor
            );
          },
        },
        {
          key: "keyframeSelectedFillColor",
          value: function keyframeSelectedFillColor(
            keyframe,
            group,
            rowStyle,
            options
          ) {
            var _keyframe$style5,
              _TimelineStyleUtils$g10,
              _TimelineStyleUtils$g11,
              _rowStyle$groupsStyle9,
              _rowStyle$groupsStyle10,
              _rowStyle$keyframesSt5,
              _options$rowsStyle9,
              _options$rowsStyle9$g,
              _options$rowsStyle9$g2,
              _options$rowsStyle10,
              _options$rowsStyle10$;
            var defaultValue =
              defaultTimelineKeyframeStyle.selectedFillColor || "";
            return TimelineStyleUtils.getFirstSet(
              // default value
              defaultValue, // exact style
              keyframe === null || keyframe === void 0
                ? void 0
                : (_keyframe$style5 = keyframe.style) === null ||
                  _keyframe$style5 === void 0
                ? void 0
                : _keyframe$style5.selectedFillColor, // style set by keyframe group
              (_TimelineStyleUtils$g10 =
                TimelineStyleUtils.getGroupStyle(group)) === null ||
                _TimelineStyleUtils$g10 === void 0
                ? void 0
                : (_TimelineStyleUtils$g11 =
                    _TimelineStyleUtils$g10.keyframesStyle) === null ||
                  _TimelineStyleUtils$g11 === void 0
                ? void 0
                : _TimelineStyleUtils$g11.selectedFillColor, // style from the keyframe group
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$groupsStyle9 = rowStyle.groupsStyle) === null ||
                  _rowStyle$groupsStyle9 === void 0
                ? void 0
                : (_rowStyle$groupsStyle10 =
                    _rowStyle$groupsStyle9.keyframesStyle) === null ||
                  _rowStyle$groupsStyle10 === void 0
                ? void 0
                : _rowStyle$groupsStyle10.selectedFillColor, // style set by keyframe style
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$keyframesSt5 = rowStyle.keyframesStyle) === null ||
                  _rowStyle$keyframesSt5 === void 0
                ? void 0
                : _rowStyle$keyframesSt5.selectedFillColor,
              // style set by keyframe group style, applied when group is set
              group
                ? options === null || options === void 0
                  ? void 0
                  : (_options$rowsStyle9 = options.rowsStyle) === null ||
                    _options$rowsStyle9 === void 0
                  ? void 0
                  : (_options$rowsStyle9$g =
                      _options$rowsStyle9.groupsStyle) === null ||
                    _options$rowsStyle9$g === void 0
                  ? void 0
                  : (_options$rowsStyle9$g2 =
                      _options$rowsStyle9$g.keyframesStyle) === null ||
                    _options$rowsStyle9$g2 === void 0
                  ? void 0
                  : _options$rowsStyle9$g2.selectedFillColor
                : undefined, // Style set by global options
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle10 = options.rowsStyle) === null ||
                  _options$rowsStyle10 === void 0
                ? void 0
                : (_options$rowsStyle10$ =
                    _options$rowsStyle10.keyframesStyle) === null ||
                  _options$rowsStyle10$ === void 0
                ? void 0
                : _options$rowsStyle10$.selectedFillColor
            );
          },
        },
        {
          key: "keyframeStrokeThickness",
          value: function keyframeStrokeThickness(
            keyframe,
            group,
            rowStyle,
            options
          ) {
            var _keyframe$style6,
              _TimelineStyleUtils$g12,
              _TimelineStyleUtils$g13,
              _rowStyle$groupsStyle11,
              _rowStyle$groupsStyle12,
              _rowStyle$keyframesSt6,
              _options$rowsStyle11,
              _options$rowsStyle11$,
              _options$rowsStyle11$2,
              _options$rowsStyle12,
              _options$rowsStyle12$;
            var defaultValue =
              defaultTimelineKeyframeStyle.strokeThickness || 0;
            return TimelineStyleUtils.getFirstSet(
              // default value
              defaultValue, // exact style
              keyframe === null || keyframe === void 0
                ? void 0
                : (_keyframe$style6 = keyframe.style) === null ||
                  _keyframe$style6 === void 0
                ? void 0
                : _keyframe$style6.strokeThickness, // style set by keyframe group
              (_TimelineStyleUtils$g12 =
                TimelineStyleUtils.getGroupStyle(group)) === null ||
                _TimelineStyleUtils$g12 === void 0
                ? void 0
                : (_TimelineStyleUtils$g13 =
                    _TimelineStyleUtils$g12.keyframesStyle) === null ||
                  _TimelineStyleUtils$g13 === void 0
                ? void 0
                : _TimelineStyleUtils$g13.strokeThickness, // style from the keyframe group
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$groupsStyle11 = rowStyle.groupsStyle) === null ||
                  _rowStyle$groupsStyle11 === void 0
                ? void 0
                : (_rowStyle$groupsStyle12 =
                    _rowStyle$groupsStyle11.keyframesStyle) === null ||
                  _rowStyle$groupsStyle12 === void 0
                ? void 0
                : _rowStyle$groupsStyle12.strokeThickness, // style set by keyframe style
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$keyframesSt6 = rowStyle.keyframesStyle) === null ||
                  _rowStyle$keyframesSt6 === void 0
                ? void 0
                : _rowStyle$keyframesSt6.strokeThickness,
              // style set by keyframe group style, applied when group is set
              group
                ? options === null || options === void 0
                  ? void 0
                  : (_options$rowsStyle11 = options.rowsStyle) === null ||
                    _options$rowsStyle11 === void 0
                  ? void 0
                  : (_options$rowsStyle11$ =
                      _options$rowsStyle11.groupsStyle) === null ||
                    _options$rowsStyle11$ === void 0
                  ? void 0
                  : (_options$rowsStyle11$2 =
                      _options$rowsStyle11$.keyframesStyle) === null ||
                    _options$rowsStyle11$2 === void 0
                  ? void 0
                  : _options$rowsStyle11$2.strokeThickness
                : undefined, // Style set by global options
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle12 = options.rowsStyle) === null ||
                  _options$rowsStyle12 === void 0
                ? void 0
                : (_options$rowsStyle12$ =
                    _options$rowsStyle12.keyframesStyle) === null ||
                  _options$rowsStyle12$ === void 0
                ? void 0
                : _options$rowsStyle12$.strokeThickness
            );
          },
        },
        {
          key: "keyframeStrokeColor",
          value: function keyframeStrokeColor(
            keyframe,
            group,
            rowStyle,
            options
          ) {
            var _keyframe$style7,
              _TimelineStyleUtils$g14,
              _TimelineStyleUtils$g15,
              _rowStyle$groupsStyle13,
              _rowStyle$groupsStyle14,
              _rowStyle$keyframesSt7,
              _options$rowsStyle13,
              _options$rowsStyle13$,
              _options$rowsStyle13$2,
              _options$rowsStyle14,
              _options$rowsStyle14$;
            ...
            return TimelineStyleUtils.getFirstSet(
              ...
              keyframe === null || keyframe === void 0
                ? void 0
                : (_keyframe$style7 = keyframe.style) === null ||
                  _keyframe$style7 === void 0
                ? void 0
                : _keyframe$style7.strokeColor, // style set by keyframe group
              (_TimelineStyleUtils$g14 =
                TimelineStyleUtils.getGroupStyle(group)) === null ||
                _TimelineStyleUtils$g14 === void 0
                ? void 0
                : (_TimelineStyleUtils$g15 =
                    _TimelineStyleUtils$g14.keyframesStyle) === null ||
                  _TimelineStyleUtils$g15 === void 0
                ? void 0
                : _TimelineStyleUtils$g15.strokeColor, // style from the keyframe group
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$groupsStyle13 = rowStyle.groupsStyle) === null ||
                  _rowStyle$groupsStyle13 === void 0
                ? void 0
                : (_rowStyle$groupsStyle14 =
                    _rowStyle$groupsStyle13.keyframesStyle) === null ||
                  _rowStyle$groupsStyle14 === void 0
                ? void 0
                : _rowStyle$groupsStyle14.strokeColor, // style set by keyframe style
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$keyframesSt7 = rowStyle.keyframesStyle) === null ||
                  _rowStyle$keyframesSt7 === void 0
                ? void 0
                : _rowStyle$keyframesSt7.strokeColor,
              // style set by keyframe group style, applied when group is set
              group
                ? options === null || options === void 0
                  ? void 0
                  : (_options$rowsStyle13 = options.rowsStyle) === null ||
                    _options$rowsStyle13 === void 0
                  ? void 0
                  : (_options$rowsStyle13$ =
                      _options$rowsStyle13.groupsStyle) === null ||
                    _options$rowsStyle13$ === void 0
                  ? void 0
                  : (_options$rowsStyle13$2 =
                      _options$rowsStyle13$.keyframesStyle) === null ||
                    _options$rowsStyle13$2 === void 0
                  ? void 0
                  : _options$rowsStyle13$2.strokeColor
                : undefined, // Style set by global options
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle14 = options.rowsStyle) === null ||
                  _options$rowsStyle14 === void 0
                ? void 0
                : (_options$rowsStyle14$ =
                    _options$rowsStyle14.keyframesStyle) === null ||
                  _options$rowsStyle14$ === void 0
                ? void 0
                : _options$rowsStyle14$.strokeColor
            );
          },
        },
        {
          key: "keyframeSelectedStrokeColor",
          value: function keyframeSelectedStrokeColor(
            keyframe,
            group,
            rowStyle,
            options
          ) {
            var _keyframe$style8,
              _TimelineStyleUtils$g16,
              _TimelineStyleUtils$g17,
              _rowStyle$groupsStyle15,
              _rowStyle$groupsStyle16,
              _rowStyle$keyframesSt8,
              _options$rowsStyle15,
              _options$rowsStyle15$,
              _options$rowsStyle15$2,
              _options$rowsStyle16,
              _options$rowsStyle16$;
            var defaultValue =
              defaultTimelineKeyframeStyle.selectedStrokeColor || "";
            return TimelineStyleUtils.getFirstSet(
              // default value
              defaultValue, // exact style
              keyframe === null || keyframe === void 0
                ? void 0
                : (_keyframe$style8 = keyframe.style) === null ||
                  _keyframe$style8 === void 0
                ? void 0
                : _keyframe$style8.selectedStrokeColor, // style set by keyframe group
              (_TimelineStyleUtils$g16 =
                TimelineStyleUtils.getGroupStyle(group)) === null ||
                _TimelineStyleUtils$g16 === void 0
                ? void 0
                : (_TimelineStyleUtils$g17 =
                    _TimelineStyleUtils$g16.keyframesStyle) === null ||
                  _TimelineStyleUtils$g17 === void 0
                ? void 0
                : _TimelineStyleUtils$g17.selectedStrokeColor, // style from the keyframe group
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$groupsStyle15 = rowStyle.groupsStyle) === null ||
                  _rowStyle$groupsStyle15 === void 0
                ? void 0
                : (_rowStyle$groupsStyle16 =
                    _rowStyle$groupsStyle15.keyframesStyle) === null ||
                  _rowStyle$groupsStyle16 === void 0
                ? void 0
                : _rowStyle$groupsStyle16.selectedStrokeColor, // style set by keyframe style
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$keyframesSt8 = rowStyle.keyframesStyle) === null ||
                  _rowStyle$keyframesSt8 === void 0
                ? void 0
                : _rowStyle$keyframesSt8.selectedStrokeColor,
              // style set by keyframe group style, applied when group is set
              group
                ? options === null || options === void 0
                  ? void 0
                  : (_options$rowsStyle15 = options.rowsStyle) === null ||
                    _options$rowsStyle15 === void 0
                  ? void 0
                  : (_options$rowsStyle15$ =
                      _options$rowsStyle15.groupsStyle) === null ||
                    _options$rowsStyle15$ === void 0
                  ? void 0
                  : (_options$rowsStyle15$2 =
                      _options$rowsStyle15$.keyframesStyle) === null ||
                    _options$rowsStyle15$2 === void 0
                  ? void 0
                  : _options$rowsStyle15$2.selectedStrokeColor
                : undefined, // Style set by global options
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle16 = options.rowsStyle) === null ||
                  _options$rowsStyle16 === void 0
                ? void 0
                : (_options$rowsStyle16$ =
                    _options$rowsStyle16.keyframesStyle) === null ||
                  _options$rowsStyle16$ === void 0
                ? void 0
                : _options$rowsStyle16$.selectedStrokeColor
            );
          },
        },
        {
          ...
          value: function groupHeight(options, group, rowStyle) {
            var _TimelineStyleUtils$g18,
              _rowStyle$groupsStyle17,
              _options$rowsStyle17,
              _options$rowsStyle17$;
            return TimelineStyleUtils.getFirstSet(
              // default value
              defaultGroupStyle.height || "auto", // exact group style
              (_TimelineStyleUtils$g18 =
                TimelineStyleUtils.getGroupStyle(group)) === null ||
                _TimelineStyleUtils$g18 === void 0
                ? void 0
                : _TimelineStyleUtils$g18.height, // Row row style
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$groupsStyle17 = rowStyle.groupsStyle) === null ||
                  _rowStyle$groupsStyle17 === void 0
                ? void 0
                : _rowStyle$groupsStyle17.height, // global styles
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle17 = options.rowsStyle) === null ||
                  _options$rowsStyle17 === void 0
                ? void 0
                : (_options$rowsStyle17$ = _options$rowsStyle17.groupsStyle) ===
                    null || _options$rowsStyle17$ === void 0
                ? void 0
                : _options$rowsStyle17$.height
            );
          },
        },
        {
          ...
          value: function groupMarginTop(options, group, rowStyle) {
            var _TimelineStyleUtils$g19,
              _rowStyle$groupsStyle18,
              _options$rowsStyle18,
              _options$rowsStyle18$;
            return TimelineStyleUtils.getFirstSet(
              // default value
              defaultGroupStyle.marginTop || "auto", // exact style
              (_TimelineStyleUtils$g19 =
                TimelineStyleUtils.getGroupStyle(group)) === null ||
                _TimelineStyleUtils$g19 === void 0
                ? void 0
                : _TimelineStyleUtils$g19.marginTop, // Row row style
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$groupsStyle18 = rowStyle.groupsStyle) === null ||
                  _rowStyle$groupsStyle18 === void 0
                ? void 0
                : _rowStyle$groupsStyle18.marginTop, // global styles
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle18 = options.rowsStyle) === null ||
                  _options$rowsStyle18 === void 0
                ? void 0
                : (_options$rowsStyle18$ = _options$rowsStyle18.groupsStyle) ===
                    null || _options$rowsStyle18$ === void 0
                ? void 0
                : _options$rowsStyle18$.marginTop
            );
          },
        },
        {
          ...
          value: function groupFillColor(options, group, rowStyle) {
            var _TimelineStyleUtils$g20,
              _rowStyle$groupsStyle19,
              _options$rowsStyle19,
              _options$rowsStyle19$;
            return TimelineStyleUtils.getFirstSet(
              // default value
              defaultGroupStyle.fillColor || "", // exact style
              (_TimelineStyleUtils$g20 =
                TimelineStyleUtils.getGroupStyle(group)) === null ||
                _TimelineStyleUtils$g20 === void 0
                ? void 0
                : _TimelineStyleUtils$g20.fillColor, // Row row style
              rowStyle === null || rowStyle === void 0
                ? void 0
                : (_rowStyle$groupsStyle19 = rowStyle.groupsStyle) === null ||
                  _rowStyle$groupsStyle19 === void 0
                ? void 0
                : _rowStyle$groupsStyle19.fillColor, // global styles
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle19 = options.rowsStyle) === null ||
                  _options$rowsStyle19 === void 0
                ? void 0
                : (_options$rowsStyle19$ = _options$rowsStyle19.groupsStyle) ===
                    null || _options$rowsStyle19$ === void 0
                ? void 0
                : _options$rowsStyle19$.fillColor
            );
          },
        ...
        },
        {
          ...
          value: function getRowHeight(rowStyle, options) {
            ...
            return TimelineStyleUtils.getFirstSet(
              ...
              rowStyle === null || rowStyle === void 0
                ? void 0
                : rowStyle.height, // Style set by global options
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle20 = options.rowsStyle) === null ||
                  _options$rowsStyle20 === void 0
                ? void 0
                : _options$rowsStyle20.height
            );
          },
        },
        {
          ...
          value: function getRowMarginBottom(rowStyle, options) {
            ...
            return TimelineStyleUtils.getFirstSet(
              ...
              rowStyle === null || rowStyle === void 0
                ? void 0
                : rowStyle.marginBottom, // Style set by global options
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle21 = options.rowsStyle) === null ||
                  _options$rowsStyle21 === void 0
                ? void 0
                : _options$rowsStyle21.marginBottom
            );
          },
        },
        {
          ...
          value: function getRowFillColor(rowStyle, options) {
            ...
            return TimelineStyleUtils.getFirstSet(
              ...
              rowStyle === null || rowStyle === void 0
                ? void 0
                : rowStyle.fillColor, // Style set by global options
              options === null || options === void 0
                ? void 0
                : (_options$rowsStyle22 = options.rowsStyle) === null ||
                  _options$rowsStyle22 === void 0
                ? void 0
                : _options$rowsStyle22.fillColor
            );
          },
        },
        {
          ...
          value: function headerHeight(options) {
            ...
            return (
              (options === null || options === void 0
                ? void 0
                : options.headerHeight) || defaultRowHeight
            );
          },
        },
        {
          ...
          value: function keyframeDraggable(keyframe, group, row, options) {
            ...
            var boolResult = TimelineStyleUtils.getValue(
              defaultValue,
              findFirstNegativeBool, // Keyframe settings
              keyframe === null || keyframe === void 0
                ? void 0
                : keyframe.draggable, // Group settings
              (_TimelineStyleUtils$g21 = TimelineStyleUtils.getGroup(group)) ===
                null || _TimelineStyleUtils$g21 === void 0
                ? void 0
                : _TimelineStyleUtils$g21.keyframesDraggable, // Row settings
        ...
        },
        {
          ...
          value: function groupDraggable(group, row, options) {
            ...
            var boolResult = TimelineStyleUtils.getValue(
              true,
              findFirstNegativeBool, // Group settings
              (_TimelineStyleUtils$g22 = TimelineStyleUtils.getGroup(group)) ===
                null || _TimelineStyleUtils$g22 === void 0
                ? void 0
                : _TimelineStyleUtils$g22.draggable, // Row settings
    ...
    })(TimelineElementType || (TimelineElementType = {})); // CONCATENATED MODULE: ./src/utils/timelineDraggableData.ts
    function timelineDraggableData_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (timelineDraggableData_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
            ? function (obj) {
                return typeof obj;
              }
        ...
        timelineDraggableData_typeof(obj)
      );
    }
    function timelineDraggableData_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          timelineDraggableData_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function timelineDraggableData_createClass(
      Constructor,
      protoProps,
      staticProps
    ) {
      if (protoProps)
        timelineDraggableData_defineProperties(
          Constructor.prototype,
          protoProps
        );
      if (staticProps)
        timelineDraggableData_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function timelineDraggableData_classCallCheck(instance, Constructor) {
      if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
      }
    }
    function timelineDraggableData_defineProperty(obj, key, value) {
      key = timelineDraggableData_toPropertyKey(key);
      if (key in obj) {
        Object.defineProperty(obj, key, {
          value: value,
          enumerable: true,
    ...
    function timelineDraggableData_toPropertyKey(arg) {
      var key = timelineDraggableData_toPrimitive(arg, "string");
      return timelineDraggableData_typeof(key) === "symbol" ? key : String(key);
    }
    function timelineDraggableData_toPrimitive(input, hint) {
      if (timelineDraggableData_typeof(input) !== "object" || input === null)
        return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (timelineDraggableData_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
     ...
     */
    var TimelineDraggableData = /*#__PURE__*/ timelineDraggableData_createClass(
      function TimelineDraggableData() {
        ...
        timelineDraggableData_defineProperty(
          this,
          "type",
          TimelineElementType.None
        );
    ...
    function timelineBaseEvent_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (timelineBaseEvent_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
            ? function (obj) {
                return typeof obj;
              }
        ...
        timelineBaseEvent_typeof(obj)
      );
    }
    function timelineBaseEvent_classCallCheck(instance, Constructor) {
      if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
      }
    }
    function timelineBaseEvent_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          timelineBaseEvent_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function timelineBaseEvent_createClass(
      Constructor,
      protoProps,
      staticProps
    ) {
      if (protoProps)
        timelineBaseEvent_defineProperties(Constructor.prototype, protoProps);
      if (staticProps)
        timelineBaseEvent_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function timelineBaseEvent_defineProperty(obj, key, value) {
      key = timelineBaseEvent_toPropertyKey(key);
      if (key in obj) {
        Object.defineProperty(obj, key, {
          value: value,
          enumerable: true,
    ...
    function timelineBaseEvent_toPropertyKey(arg) {
      var key = timelineBaseEvent_toPrimitive(arg, "string");
      return timelineBaseEvent_typeof(key) === "symbol" ? key : String(key);
    }
    function timelineBaseEvent_toPrimitive(input, hint) {
      if (timelineBaseEvent_typeof(input) !== "object" || input === null)
        return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (timelineBaseEvent_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    function timelineKeyframeChangedEvent_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (timelineKeyframeChangedEvent_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
            ? function (obj) {
                return typeof obj;
              }
        ...
        timelineKeyframeChangedEvent_typeof(obj)
      );
    }
    function timelineKeyframeChangedEvent_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          timelineKeyframeChangedEvent_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function timelineKeyframeChangedEvent_createClass(
      Constructor,
      protoProps,
      staticProps
    ) {
      if (protoProps)
        timelineKeyframeChangedEvent_defineProperties(
          Constructor.prototype,
          protoProps
        );
      if (staticProps)
        timelineKeyframeChangedEvent_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function timelineKeyframeChangedEvent_classCallCheck(
      instance,
      Constructor
    ) {
      if (!(instance instanceof Constructor)) {
    ...
    function _possibleConstructorReturn(self, call) {
      if (
        call &&
        (timelineKeyframeChangedEvent_typeof(call) === "object" ||
    ...
    function timelineKeyframeChangedEvent_defineProperty(obj, key, value) {
      key = timelineKeyframeChangedEvent_toPropertyKey(key);
      if (key in obj) {
        Object.defineProperty(obj, key, {
          value: value,
          enumerable: true,
    ...
    function timelineKeyframeChangedEvent_toPropertyKey(arg) {
      var key = timelineKeyframeChangedEvent_toPrimitive(arg, "string");
      return timelineKeyframeChangedEvent_typeof(key) === "symbol"
        ? key
        : String(key);
    }
    function timelineKeyframeChangedEvent_toPrimitive(input, hint) {
      if (
        timelineKeyframeChangedEvent_typeof(input) !== "object" ||
        input === null
      )
        return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (timelineKeyframeChangedEvent_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }

    var TimelineKeyframeChangedEvent = /*#__PURE__*/ (function (
      _TimelineBaseEvent
    ) {
      ...
      function TimelineKeyframeChangedEvent() {
        var _this;
        timelineKeyframeChangedEvent_classCallCheck(
          this,
          TimelineKeyframeChangedEvent
        );
        for (
        ...
        timelineKeyframeChangedEvent_defineProperty(
      ...
      return timelineKeyframeChangedEvent_createClass(
        TimelineKeyframeChangedEvent
      );
    })(TimelineBaseEvent); // CONCATENATED MODULE: ./src/enums/timelineEventSource.ts
    ...
    })(TimelineEventSource || (TimelineEventSource = {})); // CONCATENATED MODULE: ./src/utils/events/timelineTimeChangedEvent.ts
    function timelineTimeChangedEvent_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (timelineTimeChangedEvent_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
            ? function (obj) {
                return typeof obj;
              }
        ...
        timelineTimeChangedEvent_typeof(obj)
      );
    }
    function timelineTimeChangedEvent_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          timelineTimeChangedEvent_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function timelineTimeChangedEvent_createClass(
      ...
      if (protoProps)
        timelineTimeChangedEvent_defineProperties(
          Constructor.prototype,
          protoProps
        );
      if (staticProps)
        timelineTimeChangedEvent_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function timelineTimeChangedEvent_classCallCheck(instance, Constructor) {
      if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
      }
    }
    function timelineTimeChangedEvent_inherits(subClass, superClass) {
      if (typeof superClass !== "function" && superClass !== null) {
        throw new TypeError(
          "Super expression must either be null or a function"
        );
      ...
      Object.defineProperty(subClass, "prototype", { writable: false });
      if (superClass)
        timelineTimeChangedEvent_setPrototypeOf(subClass, superClass);
    }
    function timelineTimeChangedEvent_setPrototypeOf(o, p) {
      timelineTimeChangedEvent_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
          };
      return timelineTimeChangedEvent_setPrototypeOf(o, p);
    }
    function timelineTimeChangedEvent_createSuper(Derived) {
      var hasNativeReflectConstruct =
        timelineTimeChangedEvent_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = timelineTimeChangedEvent_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget =
            timelineTimeChangedEvent_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return timelineTimeChangedEvent_possibleConstructorReturn(this, result);
      };
    }
    function timelineTimeChangedEvent_possibleConstructorReturn(self, call) {
      if (
        call &&
        (timelineTimeChangedEvent_typeof(call) === "object" ||
          typeof call === "function")
      ) {
        return call;
      } else if (call !== void 0) {
      ...
      return timelineTimeChangedEvent_assertThisInitialized(self);
    }
    function timelineTimeChangedEvent_assertThisInitialized(self) {
      if (self === void 0) {
        throw new ReferenceError(
          "this hasn't been initialised - super() hasn't been called"
        );
    ...
    function timelineTimeChangedEvent_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function timelineTimeChangedEvent_getPrototypeOf(o) {
      timelineTimeChangedEvent_getPrototypeOf = Object.setPrototypeOf
        ? Object.getPrototypeOf.bind()
        : function _getPrototypeOf(o) {
            return o.__proto__ || Object.getPrototypeOf(o);
          };
      return timelineTimeChangedEvent_getPrototypeOf(o);
    }
    function timelineTimeChangedEvent_defineProperty(obj, key, value) {
      key = timelineTimeChangedEvent_toPropertyKey(key);
      if (key in obj) {
        Object.defineProperty(obj, key, {
          value: value,
          enumerable: true,
    ...
    function timelineTimeChangedEvent_toPropertyKey(arg) {
      var key = timelineTimeChangedEvent_toPrimitive(arg, "string");
      return timelineTimeChangedEvent_typeof(key) === "symbol"
        ? key
        : String(key);
    }
    function timelineTimeChangedEvent_toPrimitive(input, hint) {
      if (timelineTimeChangedEvent_typeof(input) !== "object" || input === null)
        return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (timelineTimeChangedEvent_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }

    var TimelineTimeChangedEvent = /*#__PURE__*/ (function (
      _TimelineBaseEvent
    ) {
      timelineTimeChangedEvent_inherits(
        TimelineTimeChangedEvent,
        _TimelineBaseEvent
      );
      var _super = timelineTimeChangedEvent_createSuper(
        TimelineTimeChangedEvent
      );
      function TimelineTimeChangedEvent() {
        ...
        _this = _super.call.apply(_super, [this].concat(args));
        timelineTimeChangedEvent_defineProperty(
          timelineTimeChangedEvent_assertThisInitialized(_this),
          "val",
          0
        );
        timelineTimeChangedEvent_defineProperty(
    ...
    })(TimelineBaseEvent); // CONCATENATED MODULE: ./src/enums/timelineSelectionEventSource.ts
    /**
    ...
    })(TimelineSelectionEventSource || (TimelineSelectionEventSource = {})); // CONCATENATED MODULE: ./src/utils/events/timelineSelectedEvent.ts
    function timelineSelectedEvent_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (timelineSelectedEvent_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
            ? function (obj) {
                return typeof obj;
              }
        ...
        timelineSelectedEvent_typeof(obj)
      );
    }
    function timelineSelectedEvent_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          timelineSelectedEvent_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function timelineSelectedEvent_createClass(
      Constructor,
      protoProps,
      staticProps
    ) {
      if (protoProps)
        timelineSelectedEvent_defineProperties(
          Constructor.prototype,
          protoProps
        );
      if (staticProps)
        timelineSelectedEvent_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function timelineSelectedEvent_classCallCheck(instance, Constructor) {
      if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
      }
    }
    function timelineSelectedEvent_defineProperty(obj, key, value) {
      key = timelineSelectedEvent_toPropertyKey(key);
      if (key in obj) {
        Object.defineProperty(obj, key, {
          value: value,
          enumerable: true,
    ...
    function timelineSelectedEvent_toPropertyKey(arg) {
      var key = timelineSelectedEvent_toPrimitive(arg, "string");
      return timelineSelectedEvent_typeof(key) === "symbol" ? key : String(key);
    }
    function timelineSelectedEvent_toPrimitive(input, hint) {
      if (timelineSelectedEvent_typeof(input) !== "object" || input === null)
        return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (timelineSelectedEvent_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }

    var TimelineSelectedEvent = /*#__PURE__*/ timelineSelectedEvent_createClass(
      function TimelineSelectedEvent() {
        ...
        timelineSelectedEvent_defineProperty(
          this,
          "mode",
          TimelineSelectionEventSource.Keyframes
        );
      }
    ...
    function timelineClickEvent_typeof(obj) {
      ...
      return (
        ...
        timelineClickEvent_typeof(obj)
      );
    }
    function timelineClickEvent_classCallCheck(instance, Constructor) {
      if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
      }
    }
    function timelineClickEvent_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          timelineClickEvent_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function timelineClickEvent_createClass(
      ...
      if (protoProps)
        timelineClickEvent_defineProperties(Constructor.prototype, protoProps);
      if (staticProps)
        timelineClickEvent_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function timelineClickEvent_inherits(subClass, superClass) {
      if (typeof superClass !== "function" && superClass !== null) {
        throw new TypeError(
          "Super expression must either be null or a function"
        );
      ...
      Object.defineProperty(subClass, "prototype", { writable: false });
      if (superClass) timelineClickEvent_setPrototypeOf(subClass, superClass);
    }
    function timelineClickEvent_setPrototypeOf(o, p) {
      timelineClickEvent_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
          };
      return timelineClickEvent_setPrototypeOf(o, p);
    }
    function timelineClickEvent_createSuper(Derived) {
      var hasNativeReflectConstruct =
        timelineClickEvent_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = timelineClickEvent_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = timelineClickEvent_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return timelineClickEvent_possibleConstructorReturn(this, result);
      };
    }
    function timelineClickEvent_possibleConstructorReturn(self, call) {
      if (
        call &&
        (timelineClickEvent_typeof(call) === "object" ||
          typeof call === "function")
      ) {
        return call;
      } else if (call !== void 0) {
      ...
      return timelineClickEvent_assertThisInitialized(self);
    }
    function timelineClickEvent_assertThisInitialized(self) {
      if (self === void 0) {
        throw new ReferenceError(
          "this hasn't been initialised - super() hasn't been called"
        );
    ...
    function timelineClickEvent_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function timelineClickEvent_getPrototypeOf(o) {
      timelineClickEvent_getPrototypeOf = Object.setPrototypeOf
        ? Object.getPrototypeOf.bind()
        : function _getPrototypeOf(o) {
            return o.__proto__ || Object.getPrototypeOf(o);
          };
      return timelineClickEvent_getPrototypeOf(o);
    }
    function timelineClickEvent_defineProperty(obj, key, value) {
      key = timelineClickEvent_toPropertyKey(key);
      if (key in obj) {
        Object.defineProperty(obj, key, {
          value: value,
          enumerable: true,
    ...
    function timelineClickEvent_toPropertyKey(arg) {
      var key = timelineClickEvent_toPrimitive(arg, "string");
      return timelineClickEvent_typeof(key) === "symbol" ? key : String(key);
    }
    function timelineClickEvent_toPrimitive(input, hint) {
      if (timelineClickEvent_typeof(input) !== "object" || input === null)
        return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (timelineClickEvent_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    var TimelineClickEvent = /*#__PURE__*/ (function (_TimelineBaseEvent) {
      ...
      function TimelineClickEvent() {
        ...
        _this = _super.call.apply(_super, [this].concat(args));
        timelineClickEvent_defineProperty(
          timelineClickEvent_assertThisInitialized(_this),
          "args",
          null
        );
        timelineClickEvent_defineProperty(
      ...
      timelineClickEvent_createClass(TimelineClickEvent, [
        {
          ...
          get:
            ...
            function get() {
              var _this$point;
              return (
                ((_this$point = this.point) === null || _this$point === void 0
                  ? void 0
                  : _this$point.pos) || null
              );
            },
        },
        {
    ...
    })(TimelineBaseEvent); // CONCATENATED MODULE: ./src/utils/events/timelineDragEvent.ts
    function timelineDragEvent_typeof(obj) {
      "@babel/helpers - typeof";
      return (
        (timelineDragEvent_typeof =
          "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
            ? function (obj) {
                return typeof obj;
              }
        ...
        timelineDragEvent_typeof(obj)
      );
    }
    function timelineDragEvent_classCallCheck(instance, Constructor) {
      if (!(instance instanceof Constructor)) {
        throw new TypeError("Cannot call a class as a function");
      }
    }
    function timelineDragEvent_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          timelineDragEvent_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function timelineDragEvent_createClass(
      Constructor,
      protoProps,
      staticProps
    ) {
      if (protoProps)
        timelineDragEvent_defineProperties(Constructor.prototype, protoProps);
      if (staticProps)
        timelineDragEvent_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function timelineDragEvent_inherits(subClass, superClass) {
      if (typeof superClass !== "function" && superClass !== null) {
        throw new TypeError(
          "Super expression must either be null or a function"
        );
      ...
      Object.defineProperty(subClass, "prototype", { writable: false });
      if (superClass) timelineDragEvent_setPrototypeOf(subClass, superClass);
    }
    function timelineDragEvent_setPrototypeOf(o, p) {
      timelineDragEvent_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
          };
      return timelineDragEvent_setPrototypeOf(o, p);
    }
    function timelineDragEvent_createSuper(Derived) {
      var hasNativeReflectConstruct =
        timelineDragEvent_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = timelineDragEvent_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = timelineDragEvent_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return timelineDragEvent_possibleConstructorReturn(this, result);
      };
    }
    function timelineDragEvent_possibleConstructorReturn(self, call) {
      if (
        call &&
        (timelineDragEvent_typeof(call) === "object" ||
          typeof call === "function")
      ) {
        return call;
      } else if (call !== void 0) {
      ...
      return timelineDragEvent_assertThisInitialized(self);
    }
    function timelineDragEvent_assertThisInitialized(self) {
      if (self === void 0) {
        throw new ReferenceError(
          "this hasn't been initialised - super() hasn't been called"
        );
    ...
    function timelineDragEvent_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function timelineDragEvent_getPrototypeOf(o) {
      timelineDragEvent_getPrototypeOf = Object.setPrototypeOf
        ? Object.getPrototypeOf.bind()
        : function _getPrototypeOf(o) {
            return o.__proto__ || Object.getPrototypeOf(o);
          };
      return timelineDragEvent_getPrototypeOf(o);
    }
    function timelineDragEvent_defineProperty(obj, key, value) {
      key = timelineDragEvent_toPropertyKey(key);
      if (key in obj) {
        Object.defineProperty(obj, key, {
          value: value,
          enumerable: true,
    ...
    function timelineDragEvent_toPropertyKey(arg) {
      var key = timelineDragEvent_toPrimitive(arg, "string");
      return timelineDragEvent_typeof(key) === "symbol" ? key : String(key);
    }
    function timelineDragEvent_toPrimitive(input, hint) {
      if (timelineDragEvent_typeof(input) !== "object" || input === null)
        return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (timelineDragEvent_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    var TimelineDragEvent = /*#__PURE__*/ (function (_TimelineBaseEvent) {
      ...
      function TimelineDragEvent() {
        ...
        _this = _super.call.apply(_super, [this].concat(args));
        timelineDragEvent_defineProperty(
          timelineDragEvent_assertThisInitialized(_this),
          "args",
          null
        );
        timelineDragEvent_defineProperty(
    ...
    })(TimelineBaseEvent); // CONCATENATED MODULE: ./src/enums/timelineInteractionMode.ts
    ...
    })(TimelineInteractionMode || (TimelineInteractionMode = {})); // CONCATENATED MODULE: ./src/enums/timelineCursorType.ts
    ...
    })(TimelineCursorType || (TimelineCursorType = {})); // CONCATENATED MODULE: ./src/enums/timelineCapShape.ts
    ...
    })(TimelineCapShape || (TimelineCapShape = {})); // CONCATENATED MODULE: ./src/enums/timelineSelectionMode.ts
    /**
    ...
    })(TimelineSelectionMode || (TimelineSelectionMode = {})); // CONCATENATED MODULE: ./src/enums/timelineEvents.ts
    /**
    ...
    })(TimelineEvents || (TimelineEvents = {})); // CONCATENATED MODULE: ./src/enums/timelineScrollSource.ts
    ...
    })(TimelineScrollSource || (TimelineScrollSource = {})); // CONCATENATED MODULE: ./src/settings/defaults/defaultTimelineConsts.ts
    ...
    function timeline_defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
        ...
        Object.defineProperty(
          target,
          timeline_toPropertyKey(descriptor.key),
          descriptor
        );
      }
    }
    function timeline_createClass(Constructor, protoProps, staticProps) {
      if (protoProps)
        timeline_defineProperties(Constructor.prototype, protoProps);
      if (staticProps) timeline_defineProperties(Constructor, staticProps);
      Object.defineProperty(Constructor, "prototype", { writable: false });
      return Constructor;
    }
    function timeline_inherits(subClass, superClass) {
      if (typeof superClass !== "function" && superClass !== null) {
        throw new TypeError(
          "Super expression must either be null or a function"
        );
      ...
      Object.defineProperty(subClass, "prototype", { writable: false });
      if (superClass) timeline_setPrototypeOf(subClass, superClass);
    }
    function timeline_setPrototypeOf(o, p) {
      timeline_setPrototypeOf = Object.setPrototypeOf
        ? Object.setPrototypeOf.bind()
        : function _setPrototypeOf(o, p) {
            o.__proto__ = p;
            return o;
          };
      return timeline_setPrototypeOf(o, p);
    }
    function timeline_createSuper(Derived) {
      var hasNativeReflectConstruct = timeline_isNativeReflectConstruct();
      return function _createSuperInternal() {
        var Super = timeline_getPrototypeOf(Derived),
          result;
        if (hasNativeReflectConstruct) {
          var NewTarget = timeline_getPrototypeOf(this).constructor;
          result = Reflect.construct(Super, arguments, NewTarget);
        } else {
          result = Super.apply(this, arguments);
        }
        return timeline_possibleConstructorReturn(this, result);
      };
    }
    function timeline_possibleConstructorReturn(self, call) {
      if (
        call &&
        (timeline_typeof(call) === "object" || typeof call === "function")
      ) {
        return call;
      } else if (call !== void 0) {
        throw new TypeError(
      ...
      return timeline_assertThisInitialized(self);
    }
    function timeline_assertThisInitialized(self) {
      if (self === void 0) {
        throw new ReferenceError(
          "this hasn't been initialised - super() hasn't been called"
        );
    ...
    function timeline_isNativeReflectConstruct() {
      if (typeof Reflect === "undefined" || !Reflect.construct) return false;
      if (Reflect.construct.sham) return false;
      if (typeof Proxy === "function") return true;
      try {
    ...
    function _superPropBase(object, property) {
      while (!Object.prototype.hasOwnProperty.call(object, property)) {
        object = timeline_getPrototypeOf(object);
        if (object === null) break;
      }
      return object;
    }
    function timeline_getPrototypeOf(o) {
      timeline_getPrototypeOf = Object.setPrototypeOf
        ? Object.getPrototypeOf.bind()
        : function _getPrototypeOf(o) {
            return o.__proto__ || Object.getPrototypeOf(o);
          };
      return timeline_getPrototypeOf(o);
    }
    function timeline_defineProperty(obj, key, value) {
      key = timeline_toPropertyKey(key);
      if (key in obj) {
        Object.defineProperty(obj, key, {
          value: value,
          enumerable: true,
    ...
    function timeline_toPropertyKey(arg) {
      var key = timeline_toPrimitive(arg, "string");
      return timeline_typeof(key) === "symbol" ? key : String(key);
    }
    function timeline_toPrimitive(input, hint) {
      if (timeline_typeof(input) !== "object" || input === null) return input;
      var prim = input[Symbol.toPrimitive];
      if (prim !== undefined) {
        var res = prim.call(input, hint || "default");
        if (timeline_typeof(res) !== "object") return res;
        throw new TypeError("@@toPrimitive must return a primitive value.");
      }
      return (hint === "string" ? String : Number)(input);
    }
    ...
    var Timeline = /*#__PURE__*/ (function (_TimelineEventsEmitte) {
      ...
      function Timeline() {
        ...
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_container",
          null
        );
        timeline_defineProperty(
        ...
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_startedDragWithCtrl",
          false
        );
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_startedDragWithShiftKey",
          false
        );
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_scrollProgrammatically",
          false
        );
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
        ...
        timeline_defineProperty(
          ...
          function (options, model) {
            ...
            if (!options || !options.id) {
              throw new Error(
                "Element cannot be empty. Should be string or DOM element."
              );
            }
        ...
        timeline_defineProperty(
          ...
          function (id) {
            ...
            _this._scrollContainer.style.cssText =
              "overflow: hidden;" +
              "position: absolute;" +
              "width:  100%;" +
              "height:  100%;" +
              "background-color: transparent;";
            _this._scrollContent.style.cssText =
              "background-color: transparent;";
            ...
            var scrollBarWidth =
              _this._scrollContainer.offsetWidth -
              _this._scrollContent.clientWidth;
            ...
            // _this._canvas.style.width = _this._canvas.style.width = 'calc(100% + 17px)'
            _this._canvas.style.width = _this._canvas.style.width = "100%";
            _this._canvas.style.width = _this._canvas.style.height = "100%";
        ...
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_subscribeComponentEvents",
          function () {
            // Allow to call event multiple times, revoke current subscription and subscribe again.
            _this._unsubscribeComponentEvents();
            if (
              !_this._container ||
              !_this._scrollContainer ||
              !_this._canvas
            ) {
              throw Error(
                "Cannot subscribe on scroll events while one of the containers is null or empty. Please call initialize method first"
              );
            }
            if (_this._container) {
              _this._container.addEventListener(
                "wheel",
                _this._handleWheelEvent
              );
            }
            if (_this._scrollContainer) {
              ...
              _this._scrollContainer.addEventListener(
                "touchstart",
                _this._handleScrollMouseDownEvent
              );
              _this._scrollContainer.addEventListener(
                "mousedown",
                _this._handleScrollMouseDownEvent
            ...
            window.addEventListener(
              "resize",
              _this._handleWindowResizeEvent,
              false
            );
            if (_this._canvas) {
              _this._canvas.addEventListener(
                "touchstart",
                _this._handleMouseDownEvent,
                false
              );
              _this._canvas.addEventListener(
                "mousedown",
        ...
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_unsubscribeComponentEvents",
          function () {
            var _this$_container;
            (_this$_container = _this._container) === null ||
            _this$_container === void 0
              ? void 0
              : _this$_container.removeEventListener(
                  "wheel",
                  _this._handleWheelEvent
                );
            if (_this._scrollContainer) {
              _this._scrollContainer.removeEventListener(
                "scroll",
                _this._handleScrollEvent
              );
              _this._scrollContainer.removeEventListener(
              ...
              console.warn(
                "Cannot unsubscribe scroll while it's already empty"
              );
            }
            ...
            if (_this._canvas) {
              _this._canvas.removeEventListener(
                "touchstart",
                _this._handleMouseDownEvent
              );
              _this._canvas.removeEventListener(
              ...
              console.warn(
                "Cannot unsubscribe canvas while it's already empty"
              );
            }
            window.removeEventListener(
              "mousemove",
        ...
        timeline_defineProperty(
          ...
          function (e) {
            if (
              !_this._options ||
              _this._options.controlKeyIsMetaKey === undefined
            ) {
              return e.metaKey || e.ctrlKey;
            }
            return _this._options.controlKeyIsMetaKey ||
              _this._options.controlKeyIsMetaKey
              ? e.metaKey
              : e.ctrlKey;
          }
        );
        timeline_defineProperty(
          ...
          function (event) {
            ...
            if (_this._controlKeyPressed(event)) {
              ...
              _this._zoom(
                TimelineUtils.sign(event.deltaY),
                _this._options.zoomSpeed || 0,
                mousePos
              );
            } else {
        ...
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_zoom",
          function (direction, speed, x) {
            if (speed && speed > 0 && speed <= 1) {
              var deltaSpeed =
                TimelineUtils.getDistance(_this._canvasClientWidth() / 2, x) *
                0.2;
              x = x + deltaSpeed;
              ...
              var newScrollLeft = Math.round(
                zoomCenter - _this._canvasClientWidth() / diff
              );
              if (newScrollLeft <= 0) {
                newScrollLeft = 0;
              }
              _this._rescaleInternal(
                newScrollLeft + _this._canvasClientWidth(),
                null,
                TimelineScrollSource.ZoomMode
              );
        ...
        timeline_defineProperty(
          ...
          function () {
            ...
            var speed =
              arguments.length > 0 && arguments[0] !== undefined
                ? arguments[0]
                : _this._options.zoomSpeed;
            var width =
              ((_this$_scrollContaine = _this._scrollContainer) === null ||
              _this$_scrollContaine === void 0
                ? void 0
                : _this$_scrollContaine.clientWidth) || 0;
            if (speed && width) {
          ...
          function () {
            ...
            var speed =
              arguments.length > 0 && arguments[0] !== undefined
                ...
                : _this._options.zoomSpeed;
            var width =
              ((_this$_scrollContaine2 = _this._scrollContainer) === null ||
              _this$_scrollContaine2 === void 0
                ? void 0
                : _this$_scrollContaine2.clientWidth) || 0;
            if (speed && width) {
              _this._zoom(-1, speed, width / 2);
            }
          }
          ...
          function (zoom) {
            ...
            var max =
              arguments.length > 2 && arguments[2] !== undefined
                ? arguments[2]
                : null;
            min = TimelineUtils.isNumber(min)
              ? min
              : (_this$_options = _this._options) === null ||
                _this$_options === void 0
              ? void 0
              : _this$_options.zoomMin;
            max = TimelineUtils.isNumber(max)
              ? max
              : (_this$_options2 = _this._options) === null ||
                _this$_options2 === void 0
              ? void 0
              : _this$_options2.zoomMax;
        ...
        timeline_defineProperty(
          ...
          function (point) {
            ...
            return Math.max(
              defaultValue,
              (point === null || point === void 0 ? void 0 : point.radius) ||
                defaultValue
            );
          }
        );
        timeline_defineProperty(
          ...
          function (args) {
            ...
            _this._startPosMouseArgs = _this._trackMousePos(
              _this._canvas,
              args
            );
            ...
            var isDoubleClick =
              Date.now() - _this._lastClickTime <
              _this._consts.doubleClickTimeoutMs;
            // Don't allow to perform double click if mouse was moved to far.
            if (
              _this._lastClickPoint &&
              _this._startPosMouseArgs &&
              TimelineUtils.getDistance(
                _this._lastClickPoint.x,
                _this._lastClickPoint.y,
                _this._startPosMouseArgs.pos.x,
                _this._startPosMouseArgs.pos.y
              ) > _this._consts.clickThreshold
            ) {
              isDoubleClick = false;
            }
            ...
            if (
              _this._interactionMode ===
                TimelineInteractionMode.NonInteractivePan ||
              _this._interactionMode === TimelineInteractionMode.None
            ) {
            ...
            var clickRadius = _this._getClickDetectionRadius(
              _this._startPosMouseArgs
            );
            var elements = _this.elementFromPoint(
              _this._startPosMouseArgs.pos,
              clickRadius,
              onlyElements
            );
            var target = _this._findDraggableElement(
              elements,
              _this._startPosMouseArgs.val
            );
            // Create click event
            ...
            if (isDoubleClick) {
              _get(
                ((_thisSuper = timeline_assertThisInitialized(_this)),
                timeline_getPrototypeOf(Timeline.prototype)),
                "emit",
                _thisSuper
              ).call(_thisSuper, TimelineEvents.DoubleClick, event);
              return;
            }
            _get(
              ((_thisSuper2 = timeline_assertThisInitialized(_this)),
              timeline_getPrototypeOf(Timeline.prototype)),
              "emit",
              _thisSuper2
            ).call(_thisSuper2, TimelineEvents.MouseDown, event);
            ...
            if (
              target &&
              _this._interactionMode !== TimelineInteractionMode.Zoom
            ) {
              _this._drag = new TimelineDraggableData();
              _this._drag.val = target.val;
              _this._drag.type = target.type;
              _this._drag.target = _this._setElementDragState(
                target,
                target.val
              );
              if (target.type === TimelineElementType.Keyframe) {
                ...
                if (
                  ...
                  !(
                    target !== null &&
                    target !== void 0 &&
                    (_target$keyframe = target.keyframe) !== null &&
                    _target$keyframe !== void 0 &&
                    _target$keyframe.selected
                  ) &&
                  !_this._controlKeyPressed(args)
                ) {
                  _this._selectInternal(target.keyframe);
                }
                // Allow to drag all selected keyframes on a screen
                _this._drag.elements = _this
                  .getSelectedElements()
                ...
                if (keyframes && Array.isArray(keyframes)) {
                  _this._drag.elements = keyframes.map(function (keyframe) {
                    var _this$_drag;
                    return _this._setElementDragState(
                      _this._convertToTimelineElement(
                        ((_this$_drag = _this._drag) === null ||
                        _this$_drag === void 0
                          ? void 0
                          : _this$_drag.target.row) || null,
                        keyframe
                      ),
                      keyframe.val
                    );
        ...
        timeline_defineProperty(
          ...
          function (args) {
            ...
            var isTouch =
              touchEventArgs.changedTouches &&
              touchEventArgs.changedTouches.length > 0;
            _this._currentPos = _this._trackMousePos(_this._canvas, args);
            if (
              !_this._isPanStarted &&
              _this._selectionRect &&
              _this._clickTimeoutIsOver()
            ) {
            ...
            if (_this._startPosMouseArgs) {
              ...
              if (isLeftClicked || isTouch) {
                if (_this._drag && !_this._startedDragWithCtrl) {
                  ...
                  if (_this._drag.type === TimelineElementType.Timeline) {
                    _this._setTimeInternal(
                      convertedVal,
                      TimelineEventSource.User
                    );
                  } else if (
                    (_this._drag.type == TimelineElementType.Keyframe ||
                      _this._drag.type == TimelineElementType.Group) &&
                    _this._drag.elements
                  ) {
                    var offset = Math.floor(convertedVal - _this._drag.val);
                    var movedOffset = _this._moveElements(
                      offset,
                      _this._drag.elements,
                      TimelineEventSource.User
                    );
                ...
                if (
                  (_this._interactionMode === TimelineInteractionMode.Pan ||
                    _this._interactionMode ===
                      TimelineInteractionMode.NonInteractivePan) &&
                  !_this._drag
                ) {
              ...
              if (target) {
                ...
                if (target.type === TimelineElementType.Group) {
                  ...
                  cursor =
                    cursor ||
                    ((_this$_options3 = _this._options) === null ||
                    _this$_options3 === void 0
                      ? void 0
                      : (_this$_options3$timel =
                          _this$_options3.timelineStyle) === null ||
                        _this$_options3$timel === void 0
                      ? void 0
                      : _this$_options3$timel.cursor) ||
                    null;
                }
                if (cursor) {
          ...
          function (args) {
            ...
            if (_this._startPosMouseArgs) {
              ...
              if (
                ...
                !_this._clickTimeoutIsOver() ||
                (_this._drag &&
                  (_this._startedDragWithCtrl ||
                    _this._startedDragWithShiftKey))
              ) {
                if (
                  _this._options &&
                  _this._interactionMode === TimelineInteractionMode.Zoom
                ...
                if (_this._interactionMode === TimelineInteractionMode.Zoom) {
                  ...
                  var keyframes = _this._getKeyframesByRectangle(
                    _this._selectionRect
                  );
                  var selectionMode = args.shiftKey
                    ? TimelineSelectionMode.Append
            ...
            _this._forEachKeyframe(function (keyframeViewModel) {
              var intersects =
                keyframeViewModel.shape === TimelineKeyframeShape.Rect
                  ? TimelineUtils.isRectIntersects(
                      keyframeViewModel.size,
                      screenRect
                    )
                  : TimelineUtils.isOverlap(
        ...
        timeline_defineProperty(
          ...
          function (pos, drag) {
            ...
            if (drag && drag.type === TimelineElementType.Keyframe) {
              ...
              if (
                _this._startedDragWithCtrl &&
                _this._controlKeyPressed(pos.args)
              ) {
              ...
              isChanged =
                _this._selectInternal(
                  (drag === null || drag === void 0
                    ? void 0
                    : (_drag$target = drag.target) === null ||
                      _drag$target === void 0
                    ? void 0
                    : _drag$target.keyframe) || null,
                  mode
                ).selectionChanged || isChanged;
              if (
                pos.args.shiftKey &&
                ((_this$_options4 = _this._options) === null ||
                _this$_options4 === void 0
                  ? void 0
                  : _this$_options4.timelineDraggable) !== false
              ) {
                // Set current timeline position if it's not a drag or selection rect small or fast click.
                isChanged =
                  _this._setTimeInternal(pos.val, TimelineEventSource.User) ||
                  isChanged;
              }
            } else {
              var _this$_options5;
              ...
              isChanged =
                _this._selectInternal(null).selectionChanged || isChanged;
              if (
                ((_this$_options5 = _this._options) === null ||
                _this$_options5 === void 0
                  ? void 0
                  : _this$_options5.timelineDraggable) !== false
              ) {
                // change timeline pos:
                // Set current timeline position if it's not a drag or selection rect small or fast click.
                isChanged =
        ...
        timeline_defineProperty(
          ...
          function (element, value) {
            var source =
              arguments.length > 2 && arguments[2] !== undefined
                ? arguments[2]
                : TimelineEventSource.Programmatically;
        ...
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_convertToTimelineElement",
          function (rowModel, keyframe) {
            var data = {
        ...
        timeline_defineProperty(
          ...
          function (state, node, value) {
            if (node.selected !== value) {
              var selectable =
                typeof node.selectable === "boolean" ? node.selectable : true;
        ...
        timeline_defineProperty(
          ...
          function () {
            var _this$_options6;
            return (
              ((_this$_options6 = _this._options) === null ||
              _this$_options6 === void 0
                ? void 0
                : _this$_options6.leftMargin) || 0
            );
          }
        );
        timeline_defineProperty(
          ...
          function () {
            if (
              !_this._ctx ||
              !_this._ctx.canvas ||
              _this._ctx.canvas.clientWidth <= 0 ||
              _this._ctx.canvas.clientHeight <= 0 ||
              !_this._options ||
              !_this._options.stepPx
            ) {
              return;
            }
            ...
            var step = TimelineUtils.findGoodStep(
              valDistance / (screenWidth / _this._options.stepPx)
            );
            ...
            if (_this._options.stepSmallPx) {
              smallStep = TimelineUtils.findGoodStep(
                valDistance / (screenWidth / _this._options.stepSmallPx)
              );
            }
            var lastTextStart = 0;
            _this._ctx.save();
        ...
        timeline_defineProperty(
          ...
          function () {
            ...
            var rowAbsoluteHeight = TimelineStyleUtils.headerHeight(
              _this._options
            );
            rows.forEach(function (row, index) {
              ...
              var rowHeight = TimelineStyleUtils.getRowHeight(
                row.style || null,
                _this._options
              );
              var marginBottom = TimelineStyleUtils.getRowMarginBottom(
                row.style || null,
                _this._options
              );
              var currentRowY =
                rowAbsoluteHeight -
                (_this._scrollContainer ? _this._scrollContainer.scrollTop : 0);
              rowAbsoluteHeight += rowHeight + marginBottom;
              if (index == 0) {
                toReturn.size.y = currentRowY;
              }
              toReturn.size.height = Math.max(
                rowAbsoluteHeight + rowHeight,
                toReturn.size.height
              );
              var rowSize = {
                x: 0,
                y: currentRowY,
              ...
              if (row && row.keyframes) {
                row.keyframes.forEach(function (keyframe) {
                  ...
                  if (!keyframe || !TimelineUtils.isNumber(keyframe.val)) {
                    console.log(
                      "Unexpected null keyframe or having invalid value"
                    );
                    return;
                  }
                  if (keyframe.hidden) {
                  ...
                  var groupViewModel =
                    ((_rowViewModel$groupsV = rowViewModel.groupsViewModels) ===
                      null || _rowViewModel$groupsV === void 0
                      ? void 0
                      : _rowViewModel$groupsV.find(function (p) {
                  ...
                  var keyframeShape = TimelineStyleUtils.keyframeShape(
                    keyframe,
                    keyframe.group,
                    row.style || null,
                    _this._options
                  );
                  var keyframeSize = _this._getKeyframePosition(
                    keyframe,
                    groupViewModel,
                    rowViewModel,
                    keyframeShape
                  ...
                  var min =
                    groupViewModel.min === null
                      ? keyframe.val
                      : Math.min(keyframe.val, groupViewModel.min);
                  var max =
                    groupViewModel.max === null
                      ? keyframe.val
                      : Math.max(keyframe.val, groupViewModel.max);
                  if (TimelineUtils.isNumber(min)) {
              ...
              rowViewModel.groupsViewModels.forEach(function (groupViewModel) {
                ...
                var groupRect = _this._getKeyframesGroupSize(
                  groupViewModel,
                  rowViewModel
                );
            ...
            if (
              TimelineUtils.isNumber(toReturn.max) &&
              (toReturn.max || toReturn.max === 0)
            ) {
          ...
          function () {
            ...
            try {
              ...
              viewModel.rowsViewModels.forEach(function (rowViewModel) {
                ...
                _this._ctx.fillStyle = TimelineStyleUtils.getRowFillColor(
                  rowViewModel.model.style || null,
                  _this._options
                );
                ...
                if (bounds !== null && bounds !== void 0 && bounds.rect) {
                  var rect =
                    bounds === null || bounds === void 0 ? void 0 : bounds.rect;
        ...
        timeline_defineProperty(
          ...
          function (rowViewModel) {
            ...
            rowViewModel === null || rowViewModel === void 0
              ? void 0
              : (_rowViewModel$groupsV2 = rowViewModel.groupsViewModels) ===
                  null || _rowViewModel$groupsV2 === void 0
              ? void 0
              : _rowViewModel$groupsV2.forEach(function (groupsViewModels) {
                  var _rowViewModel$model;
                  if (!_this._ctx) {
                    return;
                  }
                  var keyframeLaneColor = TimelineStyleUtils.groupFillColor(
                    _this._options,
                    groupsViewModels.groupModel,
                    rowViewModel === null || rowViewModel === void 0
                      ? void 0
                      : (_rowViewModel$model = rowViewModel.model) === null ||
                        _rowViewModel$model === void 0
                      ? void 0
                      : _rowViewModel$model.style
                  );
        ...
        timeline_defineProperty(
          ...
          function (rect) {
            ...
            var minY =
              TimelineStyleUtils.headerHeight(_this._options) + testOffset;
        ...
        timeline_defineProperty(
          ...
          function (groupViewModel, rowViewModel) {
            ...
            var groupHeight = TimelineStyleUtils.groupHeight(
              _this._options,
              groupModel,
              rowViewModel === null || rowViewModel === void 0
                ? void 0
                : (_rowViewModel$model2 = rowViewModel.model) === null ||
                  _rowViewModel$model2 === void 0
                ? void 0
                : _rowViewModel$model2.style
            );
            var marginTop = TimelineStyleUtils.groupMarginTop(
              _this._options,
              groupModel,
              rowViewModel === null || rowViewModel === void 0
                ? void 0
                : (_rowViewModel$model3 = rowViewModel.model) === null ||
                  _rowViewModel$model3 === void 0
                ? void 0
                : _rowViewModel$model3.style
            );
            ...
            groupHeight =
              typeof groupHeight === "string"
                ? parseInt(groupHeight)
                : groupHeight;
        ...
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_getKeyframePosition",
          function (keyframe, groupViewModel, rowViewModel, keyframeShape) {
            ...
            var groupModel =
              (groupViewModel === null || groupViewModel === void 0
                ? void 0
                : groupViewModel.groupModel) || null;
            var height = TimelineStyleUtils.keyframeHeight(
              keyframe,
              groupModel,
              rowViewModel === null || rowViewModel === void 0
                ? void 0
                : (_rowViewModel$model4 = rowViewModel.model) === null ||
                  _rowViewModel$model4 === void 0
                ? void 0
                : _rowViewModel$model4.style,
              _this._options
            );
            var width = TimelineStyleUtils.keyframeWidth(
              keyframe,
              groupModel,
              rowViewModel === null || rowViewModel === void 0
                ? void 0
                : (_rowViewModel$model5 = rowViewModel.model) === null ||
                  _rowViewModel$model5 === void 0
                ? void 0
                : _rowViewModel$model5.style,
              _this._options
            );
            if (height === "auto") {
            ...
            _this._forEachKeyframe(function (keyframeViewModel) {
              ...
              if (size) {
                ...
                if (bounds && bounds.overlapY) {
                  ...
                  _this._ctx.rect(
                    0,
                    TimelineStyleUtils.headerHeight(_this._options),
                    _this._canvasClientWidth(),
                    _this._canvasClientWidth()
                  );
                  _this._ctx.clip();
                }
                ...
                var groupModel =
                  (keyframeViewModel === null || keyframeViewModel === void 0
                    ? void 0
                    : (_keyframeViewModel$gr =
                        keyframeViewModel.groupViewModel) === null ||
                      _keyframeViewModel$gr === void 0
                    ? void 0
                    : _keyframeViewModel$gr.groupModel) || null;
                var keyframeColor = keyframe.selected
                  ? TimelineStyleUtils.keyframeSelectedFillColor(
                      keyframe,
                      groupModel,
                      rowStyle,
                      _this._options
                    )
                  : TimelineStyleUtils.keyframeFillColor(
                      keyframe,
                      groupModel,
                      rowStyle,
                      _this._options
                    );
                var border = TimelineStyleUtils.keyframeStrokeThickness(
                  keyframe,
                  groupModel,
                  rowStyle,
                  _this._options
                ...
                if (border > 0) {
                  if (keyframe.selected) {
                    strokeColor =
                      TimelineStyleUtils.keyframeSelectedStrokeColor(
                        keyframe,
                        groupModel,
                        rowStyle,
                        _this._options
                    ...
                    strokeColor = TimelineStyleUtils.keyframeStrokeColor(
                      keyframe,
                      groupModel,
                      rowStyle,
                      _this._options
        ...
        timeline_defineProperty(
          ...
          function () {
            ...
            if (_this._selectionRect && _this._selectionRectEnabled) {
              ...
              _this._ctx.strokeRect(
                _this._getSharp(_this._selectionRect.x, thickness),
                _this._getSharp(_this._selectionRect.y, thickness),
                Math.floor(_this._selectionRect.width),
                Math.floor(_this._selectionRect.height)
              );
            }
            _this._ctx.restore();
          }
        ...
        timeline_defineProperty(
          ...
          function () {
            ...
            try {
              ...
              var timeLinePos = _this._getSharp(
                _this._toScreenPx(_this._val),
                thickness
              );
        ...
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_renderTimelineCap",
          function (timeLinePos, y) {
            var _this$_options7, _this$_options7$timel;
            var capStyle =
              (_this$_options7 = _this._options) === null ||
              _this$_options7 === void 0
                ? void 0
                : (_this$_options7$timel = _this$_options7.timelineStyle) ===
                    null || _this$_options7$timel === void 0
                ? void 0
                : _this$_options7$timel.capStyle;
        ...
        timeline_defineProperty(
          ...
          function () {
            if (
              _this._scrollContainer &&
              _this._scrollContainer.scrollLeft !==
                _this._scrollContainer.scrollWidth
            ) {
        ...
        timeline_defineProperty(
          ...
          function () {
            ...
            if (
              _this.valToPx(_this._val) > _this._scrollContainer.scrollWidth
            ) {
              _this.rescale();
              if (
                !_this._isPanStarted &&
                _this._drag &&
                _this._drag.type !== TimelineElementType.Timeline
              ) {
        ...
        timeline_defineProperty(
          ...
          function (val) {
            ...
            var isChanged = _this._setTimeInternal(
              val,
              TimelineEventSource.SetTimeMethod
            );
            if (isChanged) {
              _this.rescale();
              _this.redraw();
        ...
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_applyContainersStyles",
          function () {
            if (_this._scrollContainer && _this._options) {
              var classList = _this._scrollContainer.classList;
              if (
                _this._options.scrollContainerClass &&
                !classList.contains(_this._options.scrollContainerClass)
              ) {
                classList.add(_this._options.scrollContainerClass);
              }
              if (_this._options.fillColor) {
                _this._scrollContainer.style.background =
                  _this._options.fillColor;
              }
            }
          }
        );
        timeline_defineProperty(
          ...
          function (toSet) {
            ...
            _this._options.snapStep = TimelineUtils.keepInBounds(
              _this._options.snapStep || 0,
              0,
              _this._options.stepVal || 0
            );
            _this._currentZoom = _this._setZoom(
              _this._options.zoom || 0,
              _this._options.zoomMin,
              _this._options.zoomMax
            );
            _this._options.min = TimelineUtils.isNumber(_this._options.min)
              ? _this._options.min
              : 0;
            _this._options.max = TimelineUtils.isNumber(_this._options.max)
              ? _this._options.max
              : Number.MAX_VALUE;
        ...
        timeline_defineProperty(
          ...
          function () {
            ...
            var height =
              _this._scrollContainer.clientHeight * _this._pixelRatio;
        ...
        timeline_defineProperty(
          ...
          function () {
            ...
            var scrollMode =
              arguments.length > 2 && arguments[2] !== undefined
                ? arguments[2]
                : TimelineScrollSource.DefaultMode;
            ...
            if (data && data.size) {
              ...
              var timelineGlobalPos =
                _this.valToPx(_this._val) + _this._leftMargin();
              var timelinePos = 0;
              ...
              if (timelineGlobalPos >= rightPosition) {
                if (scrollMode == TimelineScrollSource.ScrollBySelection) {
                  ...
                  timelinePos = Math.floor(
                    timelineGlobalPos + _this._leftMargin()
                  );
                } else {
              ...
              var keyframeW =
                data.size.width + _this._leftMargin() + additionalOffset;
              newWidth = Math.max(
              ...
              newHeight = Math.max(
                // active size
                Math.floor(
                  data.size.height + _this._canvasClientHeight() * 0.2
                ),
                (((_this$_scrollContaine3 = _this._scrollContainer) === null ||
                _this$_scrollContaine3 === void 0
                  ? void 0
                  : _this$_scrollContaine3.scrollTop) || 0) +
                  _this._canvasClientHeight() -
                  1,
          ...
          function (elements) {
            ...
            var filteredElements = elements.filter(function (element) {
              ...
              if (element.type === TimelineElementType.Keyframe) {
                ...
                if (
                  !TimelineStyleUtils.keyframeDraggable(
                    element.keyframe || null,
                    ((_element$keyframe = element.keyframe) === null ||
                    _element$keyframe === void 0
                      ? void 0
                      : _element$keyframe.group) || null,
                ...
                if (
                  !TimelineStyleUtils.groupDraggable(
                    element.group || null,
                    element.row || null,
                    _this._options
                  )
                ...
                var _this$_options8;
                if (
                  ((_this$_options8 = _this._options) === null ||
                  _this$_options8 === void 0
                    ? void 0
                    : _this$_options8.timelineDraggable) === false
                ) {
                  return false;
                }
        ...
        timeline_defineProperty(
          ...
          function (elements) {
            ...
            var sorted = _this
              ._filterDraggableElements(elements)
              .sort(sortDraggable);
            if (sorted.length > 0) {
        ...
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "elementFromPoint",
          function (pos, clickRadius, onlyTypes) {
            var _this$_options9;
            ...
            var width = 0;
            var timelineStyle =
              (_this$_options9 = _this._options) === null ||
              _this$_options9 === void 0
                ? void 0
                : _this$_options9.timelineStyle;
            if (timelineStyle) {
              var _timelineStyle$capSty;
              width =
                Math.max(
                  (timelineStyle.width || 1) * _this._pixelRatio,
                  ((timelineStyle === null || timelineStyle === void 0
                    ? void 0
                    : (_timelineStyle$capSty = timelineStyle.capStyle) ===
                        null || _timelineStyle$capSty === void 0
                    ? void 0
                    : _timelineStyle$capSty.width) || 0) * _this._pixelRatio ||
                    1
                ) + clickRadius;
            }
            // Allow to select timeline only by half of a header to allow select by a selector top most keyframes row.
            if (
              pos.y <= headerHeight * 0.5 ||
              (pos.x >= timeLinePos - width / 2 &&
                pos.x <= timeLinePos + width / 2)
            ) {
              toReturn.push({
                val: _this._val,
            ...
            if (pos.y >= headerHeight && _this._options.keyframesDraggable) {
              _this._forEachKeyframe(function (
                keyframeViewModel,
                _,
                isNextRow
              ) {
                ...
                if (isNextRow) {
                  var rowOverlapped = TimelineUtils.isOverlap(
                    pos.x,
                    pos.y,
                    rowViewModel.size
                  );
                  ...
                  if (rowViewModel.groupsViewModels) {
                    rowViewModel.groupsViewModels.forEach(function (
                      groupViewModel
                    ) {
                      if (
                        !(
                          groupViewModel !== null &&
                          groupViewModel !== void 0 &&
                          groupViewModel.size
                        )
                      ) {
                        return;
                      }
                      var keyframesGroupOverlapped = TimelineUtils.isOverlap(
                        pos.x,
                        pos.y,
                        groupViewModel.size
                      );
                      if (keyframesGroupOverlapped) {
                        var keyframesModels =
                          (groupViewModel === null || groupViewModel === void 0
                            ? void 0
                            : groupViewModel.keyframesViewModels.map(function (
                                p
                              ) {
                                return p.model;
                              })) || [];
                ...
                if (keyframePosRect) {
                  ...
                  if (keyframeViewModel.shape === TimelineKeyframeShape.Rect) {
                    ...
                    isMouseOver = TimelineUtils.isRectIntersects(
                      extendedMouseRect,
                      keyframePosRect,
                      true
                    );
                  } else {
                    var dist = TimelineUtils.getDistance(
                      keyframePosRect.x,
                      keyframePosRect.y,
                      pos.x,
                      pos.y
        ...
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_emitScrollEvent",
          function (args, scrollProgrammatically) {
            var _this$_scrollContaine4, _this$_scrollContaine5;
            var eventType =
              arguments.length > 2 && arguments[2] !== undefined
                ? arguments[2]
                : TimelineEvents.Scroll;
            var scrollEvent = {
              args: args,
              ...
              scrollHeight:
                ((_this$_scrollContaine4 = _this._scrollContainer) === null ||
                _this$_scrollContaine4 === void 0
                  ? void 0
                  : _this$_scrollContaine4.scrollHeight) || 0,
              scrollWidth:
                ((_this$_scrollContaine5 = _this._scrollContainer) === null ||
                _this$_scrollContaine5 === void 0
                  ? void 0
                  : _this$_scrollContaine5.scrollWidth) || 0,
            };
            _get(
              ((_thisSuper3 = timeline_assertThisInitialized(_this)),
              timeline_getPrototypeOf(Timeline.prototype)),
              "emit",
              _thisSuper3
            ).call(_thisSuper3, eventType, scrollEvent);
            return scrollEvent;
          }
        );
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_emitKeyframeChanged",
          function (element) {
            var source =
              arguments.length > 1 && arguments[1] !== undefined
                ? arguments[1]
        ...
        timeline_defineProperty(
          timeline_assertThisInitialized(_this),
          "_getDragEventArgs",
          function (dragState, point) {
            var draggableArguments = new TimelineDragEvent();
            draggableArguments.point = point;
            // Get cloned list
            draggableArguments.elements = _toConsumableArray(
              dragState.elements || []
            );
            draggableArguments.target =
      ...
      timeline_createClass(Timeline, [
            ...
            function _moveElements(offset, elements) {
              ...
              if (Math.abs(offset) > 0) {
                ...
                elements.forEach(function (p) {
                  ...
                  var currentBounds = TimelineUtils.setMinMax(
                  ...
                  var expectedKeyframeValue =
                    (_this2$_options = _this2._options) !== null &&
                    _this2$_options !== void 0 &&
                    _this2$_options.snapAllKeyframesOnMove
                      ? _this2.snapVal(p.keyframe.val)
                      : p.keyframe.val;
                  var newPosition = expectedKeyframeValue + offset;
                  // Check that move offset will hit min bounds
                  if (
                    (currentBounds.min || currentBounds.min === 0) &&
                    TimelineUtils.isNumber(currentBounds.min) &&
                    newPosition < currentBounds.min
                  ) {
                    // Return to the bounds:
                    offset =
                      offset +
                      TimelineUtils.getDistance(currentBounds.min, newPosition);
                  }
                  if (
                    (currentBounds.max || currentBounds.max === 0) &&
                    TimelineUtils.isNumber(currentBounds.max) &&
                    newPosition > currentBounds.max
                  ) {
                    // Return to the bounds:
                    offset =
                      offset -
                      TimelineUtils.getDistance(currentBounds.max, newPosition);
                  }
                });
                if (Math.abs(offset) > 0) {
                  ...
                  elements.forEach(function (element) {
                    ...
                    var newValue = _this2._setKeyframePos(
                      element,
                      toSet,
                      source
                    );
        ...
        },
        {
          ...
          value:
            ...
            function _forEachKeyframe(callback) {
              ...
              calculatedModel === null || calculatedModel === void 0
                ? void 0
                : (_calculatedModel$rows = calculatedModel.rowsViewModels) ===
                    null || _calculatedModel$rows === void 0
                ? void 0
                : _calculatedModel$rows.forEach(function (rowViewModel) {
                    if (!rowViewModel) {
                      return;
                    }
                    var nextRow = true;
                    rowViewModel.keyframesViewModels.forEach(function (
                      keyframeViewModel,
                      keyframeIndex
                    ) {
        ...
        },
        {
          ...
          value: function _trackMousePos(canvas, mouseArgs) {
            ...
            if (this._startPosMouseArgs) {
              ...
              var x = Math.floor(
                startPos.x +
                  ((((_this$_scrollStartPos = this._scrollStartPos) === null ||
                  _this$_scrollStartPos === void 0
                    ? void 0
                    : _this$_scrollStartPos.x) || 0) -
                    this.scrollLeft)
              );
              var y = Math.floor(
                startPos.y +
                  ((((_this$_scrollStartPos2 = this._scrollStartPos) === null ||
                  _this$_scrollStartPos2 === void 0
                    ? void 0
                    : _this$_scrollStartPos2.y) || 0) -
                    this.scrollTop)
              );
              this._selectionRect.x = Math.min(x, pos.x);
              this._selectionRect.y = Math.min(y, pos.y);
              this._selectionRect.width =
                Math.max(x, pos.x) - this._selectionRect.x;
              this._selectionRect.height =
                Math.max(y, pos.y) - this._selectionRect.y;
              // Once mouse was moved outside of the bounds it's not a click anymore
              if (this._clickAllowed) {
                this._clickAllowed =
                  this._selectionRect.height <= this._consts.clickThreshold &&
                  this._selectionRect.width <= this._consts.clickThreshold;
              }
            }
            return clickArgs;
          },
        ...
        },
        {
          ...
          value: function getClientWidth() {
            ...
            return (
              ((_this$_scrollContaine6 = this._scrollContainer) === null ||
              _this$_scrollContaine6 === void 0
                ? void 0
                : _this$_scrollContaine6.clientWidth) || 0
            );
          },
          /**
        ...
        },
        {
          ...
          value: function getClientHeight() {
            ...
            return (
              ((_this$_scrollContaine7 = this._scrollContainer) === null ||
              _this$_scrollContaine7 === void 0
                ? void 0
                : _this$_scrollContaine7.clientHeight) || 0
            );
          },
        },
        {
        ...
        },
        {
          ...
          value: function _clickTimeoutIsOver() {
            ...
            if (
              this._clickTimeout &&
              Date.now() - this._clickTimeout > this._consts.clickDetectionMs
            ) {
              return true;
            }
            return false;
        ...
        },
        {
          ...
          value:
            ...
            function _checkUpdateSpeedTooFast() {
              ...
              if (
                this._autoPanLastActionDate &&
                Date.now() - this._autoPanLastActionDate <=
                  this._consts.autoPanSpeedLimit
              ) {
                return true;
              }
        ...
        },
        {
          ...
          value: function _scrollByPan(start, pos, scrollStartPos) {
            ...
            if (
              offsetX > 0 &&
              newLeft + this._canvasClientWidth() >=
                this._scrollContainer.scrollWidth - 5
            ) {
        ...
        },
        {
          ...
          value: function _scrollBySelectionOutOfBounds(pos) {
            ...
            if (isLeft || isRight || isTop || isBottom) {
              ...
              var scrollSpeedMultiplier = isNaN(this._consts.scrollByDragSpeed)
                ? 1
                : this._consts.scrollByDragSpeed;
              if (isLeft) {
                // Get normalized speed.
                speedX =
                  -TimelineUtils.getDistance(x, bounds) * scrollSpeedMultiplier;
              } else if (isRight) {
                // Get normalized speed:
                speedX =
                  TimelineUtils.getDistance(
                    x,
                    this._canvasClientWidth() - bounds
              ...
              if (isTop) {
                // Get normalized speed.
                speedY =
                  (-TimelineUtils.getDistance(x, bounds) *
                    scrollSpeedMultiplier) /
                  4;
              } else if (isBottom) {
                // Get normalized speed:
                speedY =
                  (TimelineUtils.getDistance(
                    x,
                    this._canvasClientHeight() - bounds
                  ) *
                    scrollSpeedMultiplier) /
                  4;
                newHeight =
                  this._scrollContainer.scrollTop + this._canvasClientHeight();
              }
            } else {
              this._stopAutoPan();
            }
            if (newWidth || newHeight) {
              this._rescaleInternal(
                newWidth,
                newHeight,
                TimelineScrollSource.ScrollBySelection
              );
            }
        ...
        },
        {
          ...
          value:
            ...
            function snapVal(val) {
              ...
              if (
                this._options &&
                this._options.snapEnabled &&
                this._options.snapStep
              ) {
                var stops = this._options.snapStep;
                var step = val / stops;
                var stepsFit = Math.round(step);
                var minSteps =
                  Math.abs(this._options.min || 0) / this._options.snapStep;
                var minOffset =
                  TimelineUtils.sign(this._options.min || 1) *
                  (minSteps - Math.floor(minSteps)) *
                  this._options.snapStep;
                val = Math.round(minOffset) + Math.round(stepsFit * stops);
              }
              val = TimelineUtils.keepInBounds(
                val,
                this._options.min,
                this._options.max
              );
        ...
        },
        {
          ...
          get:
            ...
            function get() {
              ...
              return (
                ((_this$_scrollContaine8 = this._scrollContainer) === null ||
                _this$_scrollContaine8 === void 0
                  ? void 0
                  : _this$_scrollContaine8.scrollLeft) || 0
              );
            },
        ...
        },
        {
          ...
          get: function get() {
            ...
            return (
              ((_this$_scrollContaine9 = this._scrollContainer) === null ||
              _this$_scrollContaine9 === void 0
                ? void 0
                : _this$_scrollContaine9.scrollTop) || 0
            );
          },
          set: function set(value) {
            if (
      ...
      return Timeline;
    })(TimelineEventsEmitter); // CONCATENATED MODULE: ./src/animation-timeline.ts
    // bundle entry point
